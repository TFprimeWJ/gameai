...
for i in range(2):
    i = i + 10
    print("#################### Best " + str(i) + " vs Random ####################")
    # nnet players
    name = "best" + str(i) + ".pth.tar"
    n1 = NNet(g)
    n1.load_checkpoint('./temp/best', name)
...
#     else:
#         n2 = NNet(g)
#         n2.load_checkpoint('./temp/best', 'best20.pth.tar')
...
#         player2 = n2p  # Player 2 is neural network if it's cpu vs cpu.
    ...
    arena = Arena.Arena(n1p, op, g, display=FiveinarowGame.display)
